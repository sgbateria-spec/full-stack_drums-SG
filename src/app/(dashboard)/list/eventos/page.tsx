...
import { Clase, Evento, Prisma } from "@prisma/client";
import Image from "next/image";
import Link from "next/link";

type EventoList = Evento & {clase:Clase}; 
...
const renderRow = (item: EventoList) => (
...
const EventoListPage = async ({
    ...
    const query: Prisma.EventoWhereInput = {};
    ...
    const [data, count] = await prisma.$transaction([
        ...
        prisma.evento.count({ where: query }),
    ]);
