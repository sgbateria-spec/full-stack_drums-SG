                ...
                <div className="flex flex-col lg:flex-row gap-4">
                    ...
                    <div className="bg-lamaSky py-6 px-4 rounded-md flex-1 flex gap-4">
                        ...
                        <div className="w-2/3 flex flex-col justify-between gap-4">
                            <div className="flex items-center gap-4">
                                <h1 className="text-xl font-semibold">Marcelo Amaro</h1>
                                    <FormModal table="maestro" type="update" data={
                                        {
                                            id: 1,
                                            username: "marceloamaro",
                                            email: "maa@marceloamaro.com",                                        password: "password",
                                            firstName: "Marcelo",
                                            lastName: "Amaro",
                                            phone: "1234567890",
                                            address: "20 de setiembre",
                                            bloodType: "A+",
                                            birthday: "23-09-1977",
                                            sex: "hombre",
                            ...
                            <div className="flex items-center justify-between gap-2 flex-wrap text-xs font-medium">
                                ...
                                <div className="w-full md:w-1/3 lg:w-full flex items-center gap-2">
                                    ...
                                    <span>marceloamaro@gmail.com</span>
                                </div>
                                <div className="w-full md:w-1/3 lg:w-full flex items-center gap-2">
                    ...
                    <div className="flex-1 flex gap-4 justify-between flex-wrap">
                        ...
                        <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
                            ...
                            <div className="">
                                <h1 className="text-xl font-semibold">602</h1>
                ...
                <div className="bg-white p-4 rounded-md">
                    <h1 className="text-xl font-semibold">
                        <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
                            <Link className="p-3 rounded-md bg-lamaSkyLight" href="/">Clases</Link>
                            <Link className="p-3 rounded-md bg-lamaPurpleLight" href="/">Estudiantes</Link>
                            <Link className="p-3 rounded-md bg-lamaYellowLight" href="/">Lecciones</Link>
